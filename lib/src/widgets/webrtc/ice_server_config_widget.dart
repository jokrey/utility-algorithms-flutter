...
class _IceServersConfigurationWidgetState
  ...
  _IceServersConfigurationWidgetState(iceServers) {
    for (var iceS in iceServers) {
      ...
      if (url != null) {
        serverConfigurators
            .add(_IceServerConfigurationWidget(url, username, credential));
      }
    }
  }
  ...
  _applyChangesAndPop() {
    ...
    for (var iceConfigW in serverConfigurators) {
      ...
      if (iceConfigW.representsTurnServer) {
        ...
        jsonListOfIceServers
            .add({'url': url.startsWith('stun:') ? url : 'stun:$url'});
      }
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
            ...
            children: serverConfigurators.map((e) {
              return Card(
                ...
                children: [
                  ...
                  e,
                  _WidthFillingTextButton("Remove",
                      bg: Color(0xffA71D31),
                      onPressed: () => setState(() {
        ...
        _WidthFillingTextButton("Add Ice Server",
            bg: Color(0xffA71D31),
            onPressed: () => setState(() {
                  serverConfigurators
                      .add(_IceServerConfigurationWidget("", "", ""));
                })),
        _WidthFillingTextButton(
          "Apply Changes",
